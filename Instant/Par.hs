...
#endif
newtype HappyWrap11 = HappyWrap11 (Instant.Abs.Ident)
happyIn11 :: (Instant.Abs.Ident) -> (HappyAbsSyn )
...
{-# INLINE happyOut12 #-}
newtype HappyWrap13 = HappyWrap13 (Instant.Abs.Program)
happyIn13 :: (Instant.Abs.Program) -> (HappyAbsSyn )
happyIn13 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap13 x)
{-# INLINE happyIn13 #-}
happyOut13 :: (HappyAbsSyn ) -> HappyWrap13
happyOut13 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut13 #-}
newtype HappyWrap14 = HappyWrap14 (Instant.Abs.Stmt)
happyIn14 :: (Instant.Abs.Stmt) -> (HappyAbsSyn )
happyIn14 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap14 x)
{-# INLINE happyIn14 #-}
happyOut14 :: (HappyAbsSyn ) -> HappyWrap14
happyOut14 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut14 #-}
newtype HappyWrap15 = HappyWrap15 ([Instant.Abs.Stmt])
happyIn15 :: ([Instant.Abs.Stmt]) -> (HappyAbsSyn )
happyIn15 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap15 x)
{-# INLINE happyIn15 #-}
happyOut15 :: (HappyAbsSyn ) -> HappyWrap15
happyOut15 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut15 #-}
newtype HappyWrap16 = HappyWrap16 (Instant.Abs.Exp)
happyIn16 :: (Instant.Abs.Exp) -> (HappyAbsSyn )
happyIn16 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap16 x)
{-# INLINE happyIn16 #-}
happyOut16 :: (HappyAbsSyn ) -> HappyWrap16
happyOut16 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut16 #-}
newtype HappyWrap17 = HappyWrap17 (Instant.Abs.Exp)
happyIn17 :: (Instant.Abs.Exp) -> (HappyAbsSyn )
happyIn17 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap17 x)
{-# INLINE happyIn17 #-}
happyOut17 :: (HappyAbsSyn ) -> HappyWrap17
happyOut17 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut17 #-}
newtype HappyWrap18 = HappyWrap18 (Instant.Abs.Exp)
happyIn18 :: (Instant.Abs.Exp) -> (HappyAbsSyn )
happyIn18 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap18 x)
{-# INLINE happyIn18 #-}
happyOut18 :: (HappyAbsSyn ) -> HappyWrap18
happyOut18 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut18 #-}
newtype HappyWrap19 = HappyWrap19 (Instant.Abs.Exp)
happyIn19 :: (Instant.Abs.Exp) -> (HappyAbsSyn )
happyIn19 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap19 x)
{-# INLINE happyIn19 #-}
happyOut19 :: (HappyAbsSyn ) -> HappyWrap19
happyOut19 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut19 #-}
newtype HappyWrap20 = HappyWrap20 (Instant.Abs.Exp)
happyIn20 :: (Instant.Abs.Exp) -> (HappyAbsSyn )
...
happyReduction_11 happy_x_3
	...
	happyIn14
		 (Instant.Abs.SAss happy_var_1 happy_var_3
	)}}
...
happyReduction_16 happy_x_3
	...
	happyIn16
		 (Instant.Abs.ExpAdd happy_var_1 happy_var_3
	)}}
...
happyReduction_18 happy_x_3
	...
	happyIn17
		 (Instant.Abs.ExpSub happy_var_1 happy_var_3
	)}}
...
happyReduction_20 happy_x_3
	...
	happyIn18
		 (Instant.Abs.ExpMul happy_var_1 happy_var_3
	)}}
...
happyReduction_21 happy_x_3
	...
	case happyOut19 happy_x_3 of { (HappyWrap19 happy_var_3) -> 
	happyIn18
		 (Instant.Abs.ExpDiv happy_var_1 happy_var_3
	)}}
...
happyReduction_23 happy_x_1
	...
	happyIn19
		 (Instant.Abs.ExpLit happy_var_1
	)}
...
happyReduction_24 happy_x_1
	 =  case happyOut11 happy_x_1 of { (HappyWrap11 happy_var_1) -> 
	happyIn19
		 (Instant.Abs.ExpVar happy_var_1
	)}
